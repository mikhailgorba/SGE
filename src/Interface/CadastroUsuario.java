...
public class CadastroUsuario<criptografar> extends javax.swing.JInternalFrame {
						...
						layout.createSequentialGroup()
								...
								.addGroup(
										layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												...
												.addComponent(campoSenha)).addContainerGap()));
				...
				layout.createSequentialGroup()
						...
						.addGroup(
								layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(botaoCadastrarUsuario).addComponent(botaoCancelarUsuario))
	...
	private void botaoCadastrarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			...
			senhaCriptografada = algorithm.digest(senha.getBytes("UTF-8"));
