...
public class EfetuarLogin extends javax.swing.JFrame {
    ...
    private boolean consultaUsuarioAdministrador(String usuarioSenha)
    {
        boolean logar = false;
        try {
            BufferedReader buffRead = new BufferedReader(new FileReader("BancoDeArquivos/administradores.txt"));
    ...
    private boolean consultaUsuario(String usuarioSenha)
    {
        boolean logar = false;
        try {
            BufferedReader buffRead = new BufferedReader(new FileReader("BancoDeArquivos/usuarios.txt"));
            String linha = buffRead.readLine();
            while (true) {
                if (linha != null) {
                    if (linha.equals(usuarioSenha))
